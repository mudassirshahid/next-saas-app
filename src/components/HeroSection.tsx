...
function HeroSection() {
  return (
    <>
      <div className="relative w-full bg-slate-950h-auto lg:h-[77rem] md:h-[65rem] sm:h-[50rem] h-full rounded-md flex flex-col items-center justify-center overflow-hidden mx-auto pt-10 md-py-0">
      ...
      /> */}
        <motion.div 
         ...
         viewport={{ once: false }}
         className="p-4 pb-0 relative z-10 w-full text-center">
          <motion.h1
           className="mt-20 md:mt-0 text-4xl md:text-6xl md:leading-[71px] font-medium bg-clip-text text-transparent bg-[linear-gradient(90deg,#989CA5_0%,#FFFFFF_30.4%,#FFFFFF_62.9%,#989CA5_100%)]">
        ...
        <div className="xl:left-[2%] left-[4%] relative">
          <motion.div
          initial={{ opacity: 0, scale: 0.8 }} 
          whileInView={{ opacity: 1, scale: 1 }} 
          transition={{ duration: 1, ease: "easeOut" }}
          viewport={{ once: false, amount: 0.3 }} 
            className="w-[100%] h-[100%]  bg-no-repeat xl:bg-[length:60rem_43rem] xl:bg-[50%_50%] md:bg-[50%_50%] md:bg-[length:40rem_27rem] sm:bg-[50%_50%] sm:bg-[length:20rem_20rem] bg-[50%_50%] bg-[length:0rem_0rem]"
            style={{
              backgroundImage: `url(${ellipse.src})`,
            }}>
          <div className="flex justify-center items-center m-auto w-3/4">
