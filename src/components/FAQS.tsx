...
const FAQS = () => {
  return (
    ...
    >
    <div 
    className="p-4 relative z-10 w-full text-center my-5">
  ...
  <details className="rounded-xl group [&_summary::-webkit-details-marker]:hidden bg-[radial-gradient(43.69%_75.71%_at_50%_44.52%,#10141A_0%,#0C1018_50%,#0A1017_100%)] 
...
">
  ...
  <details className="rounded-xl group [&_summary::-webkit-details-marker]:hidden bg-[radial-gradient(43.69%_75.71%_at_50%_44.52%,#13101A_0%,#0F0C18_50%,#0D0A17_100%)] 
                border border-transparent 
                [border-image-source:radial-gradient(100%_100%_at_50%_0%,rgba(124,119,148,0.4)_0%,rgba(124,119,148,0.2)_100%)]">
    <summary
      className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg p-4 text-white"
    >
      <h2 className="font-medium">Why should I upgrade to the Starter plan?</h2>
