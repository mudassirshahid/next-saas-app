  ...
  return (
    <>
        ...
        className="p-10 pb-0 relative z-10 w-full text-center">
          <motion.h3 className="mt-20 md:mt-0 text-4xl md:text-6xl md:leading-[71px] font-medium  text-white">
            Get Started
          </motion.h3>
          ...
          className="mb-7 relative mt-6 flex sm:flex-row flex-col justify-center items-center gap-3">
           ...
           <div
            className="absolute top-0 right-0 left-0 bg-[radial-gradient(46.67%_62.09%_at_50%_50%,rgba(0,89,255,0.37)_0%,rgba(1,1,1,0.32)_100%)] bg-no-repeat bg-[0rem_7rem] bg-cover w-[100%] h-[25rem] overflow-hidden"
          >
