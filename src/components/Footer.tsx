...
const Footer: React.FC = () => {
  return (
    <footer
      className="relative z-50 border-t border-transparent bg-[linear-gradient(180deg,#0B0E15_0%,#010101_100%)] text-white font-medium px-4 sm:py-20 py-12 overflow-hidden"
      style={{
        borderImageSource:
