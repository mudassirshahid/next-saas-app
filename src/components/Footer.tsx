...
const Footer: React.FC = () => {
  return (
    <footer className="relative z-50 border-t border-transparent bg-[linear-gradient(180deg,#0B0E15_0%,#010101_100%)] text-white font-medium px-4 py-12 overflow-hidden"
    style={{
      borderImageSource:
  ...
  <div className="col-span-12 md:col-span-5">
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex flex-col flex-wrap gap-3">
        <li>1234 Innovation Blvd, Suite 567<br className="lg:block"/> Tech City, TC 98765, United States.</li>
        <li>(555) 123-4567</li>
