...
const Pricing = () => {
  ...
  variants={{
   ...
   className="grid grid-cols-1 gap-4 sm:items-stretch lg:grid-cols-3 md:gap-8">
    ...
    className="lg:text-left text-center border-t border-transparent border bg-[radial-gradient(43.69%_75.71%_at_50%_44.52%,#10141A_0%,#0C121C_50%,#0A1017_100%)] text-white font-medium py-5"
    style={{
      borderImageSource:
      ...
      <div className="p-6 sm:px-8">
        ...
        <p className="mt-2 sm:mt-4">
          <strong className="text-4xl font-medium text-white sm:text-4xl"> 0$ </strong>

          <span className="text-sm font-medium text-gray-200">/monthly</span>
        </p>
        <p className="mt-2 text-white text-sm font-normal">Perfect for custom animation and motion graphics.</p>
        ...
        <ul className="space-y-4">
          <li className="flex lg:justify-start justify-center items-center gap-2">
           <Image src={check} alt='check-circle' />
            <span className="text-white font-medium text-sm"> Unlimited files </span>
          </li>
    ...
    className="lg:text-left text-center border-t border-transparent border bg-[linear-gradient(180deg,#1B1430_0%,#0F0D16_50%,#1B1430_100%)] text-white font-medium py-5"
    style={{
      borderImageSource:
        "linear-gradient(90deg, #192235 0%, #0059FF 40%, #6FADFF 50%, #0059FF 60%, #192235 100%)",
      borderImageSlice: 1,
      ...
      <div className="flex lg:flex-row flex-col justify-between items-center gap-3">
        <h2 className="text-xl font-medium text-white">
          ...
          <span className="sr-only">Plan</span>
            ...
            <button style={{background: "radial-gradient(77.66% 77.66% at 50% 50%, #181620 15.9%, #1E1930 50.9%, #332C4F 100%)",}} className="z-0 border-[#0099FF] rounded-full text-white text-[14px] font-medium px-5 py-3 shadow-[inset_0px_-4px_12px_0px_#6B49FF99,0px_16px_32px_0px_#00000033] bg-[#03263D]">
              Popular 
            </button>
      </div>
        <p className="mt-2 sm:mt-4">
          <strong className="text-4xl font-medium text-white sm:text-4xl"> 20$ </strong>
    ...
    style={{
      ...
      <div className="p-6 sm:px-8">
        ...
        <p className="mt-2 sm:mt-4">
          <strong className="text-4xl font-medium text-white sm:text-4xl"> Custom </strong>
        </p>
        <p className="mt-2 text-white text-sm font-normal">Perfect for custom animation and motion graphics.</p>
